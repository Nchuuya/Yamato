...
from YamatoRobot import dispatcher, telethn
from YamatoRobot.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
from YamatoRobot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("YamatoRobot.modules.", 1)[1]
